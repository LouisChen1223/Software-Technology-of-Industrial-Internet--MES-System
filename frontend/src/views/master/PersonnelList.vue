<template>
  <el-card>
    ...
    <el-table :data="list" height="60vh">
      ...
      <el-table-column prop="shiftCode" label="班次" width="120"/>
    ...
    <el-dialog v-model="dlg" :title="form.id? '编辑人员': '新建人员'" width="520px">
      <el-form :model="form" label-width="90px">
        ...
        <el-form-item label="班次"><el-input v-model="form.shiftCode"/></el-form-item>
...
import type { Person } from '@/types/master'
import { personApi } from '@/api/masterData'
...
function openAdd() {
  form.value = { active: true, role: 'operator' } as any
  dlg.value = true
}
